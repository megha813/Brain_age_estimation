...
parser.add_argument('--train_folder'   ,default='/home/ubuntu/Documents/Megha/TRIAMESE_DATA/TRIAMESE_TRAIN'         ,type=str, help="Train set data path ")
parser.add_argument('--valid_folder'   ,default='/home/ubuntu/Documents/Megha/TRIAMESE_DATA/TRIAMESE_VAL'         ,type=str, help="Validation set data path ")
parser.add_argument('--test_folder'    ,default='/home/ubuntu/Documents/Megha/TRIAMESE_DATA/TRIAMESE_TEST'          ,type=str, help="Test set data path ")
parser.add_argument('--mask_folder'    ,default='/home/ubuntu/Documents/Megha/TRIAMESE_DATA/TRIAMESE_TEST'          ,type=str, help="Mask set data path ")

parser.add_argument('--excel_path'     ,default='/home/ubuntu/Documents/Megha/TRIAMESE_DATA.xlsx',type=str, help="Excel file path ")
