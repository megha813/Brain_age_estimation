...
parser.add_argument('--output_dir'     ,default='training_output_metrics') #it was training_output_metrics              ,type=str, help="Output dictionary, whici will contains training log and model checkpoint")
parser.add_argument('--train_folder'   ,default='/home/omen/Documents/Megha/TRIAMESE_DATA/TRIAMESE_TRAIN'         ,type=str, help="Train set data path ")
parser.add_argument('--valid_folder'   ,default='/home/omen/Documents/Megha/TRIAMESE_DATA/TRIAMESE_VAL'         ,type=str, help="Validation set data path ")
parser.add_argument('--test_folder'    ,default='/home/omen/Documents/Megha/TRIAMESE_DATA/TRIAMESE_TEST'          ,type=str, help="Test set data path ")
parser.add_argument('--mask_folder'    ,default='/home/omen/Documents/Megha/TRIAMESE_DATA/TRIAMESE_TEST'          ,type=str, help="Mask set data path ")

parser.add_argument('--excel_path'     ,default='/home/omen/Documents/Megha/TRIAMESE_DATA/TRIAMESE_DATA.xlsx',type=str, help="Excel file path ")
...
parser.add_argument('--batch_size'  ,default=100       ,type=int,   help="Batch size during training process")
